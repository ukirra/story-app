...
function EditStory() {
  ...
  const handleSave = async () => {
    ...
    let coverData = cover;
    if (cover && typeof cover !== 'string' && cover instanceof File) {
  ...
  return (
    <div className="flex min-h-screen font-inter">
      ...
      <div className="flex-1 p-12 max-w-6xl mx-auto relative">
        <h2 className="text-3xl font-bold text-gray-900 mb-8">Edit Story</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white rounded-xl shadow-md p-6 border border-gray-200">
          ...
          <div>
            ...
            {cover && (typeof cover === 'string' ? (
              <img src={cover} alt="Story Cover" className="mt-2 w-32 h-auto rounded-md border border-gray-300" />
            ) : (
              <img src={URL.createObjectURL(cover)} alt="Story Cover" className="mt-2 w-32 h-auto rounded-md border border-gray-300" />
            ))}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag, i) => (
                <span key={i} className="inline-flex items-center bg-violet-100 text-violet-700 px-3 py-1 rounded-full text-xs">
